  ...
  <v-app>
    <v-container>
      ...
      <v-row justify="center">
        <v-text-field class="mb-2" label="Nome do Responsável" placeholder="Ex: Maria Fernanda" outlined dense
          style="width: 90%;" v-model="responsavel.nome"></v-text-field>
        <v-text-field class="mb-2" label="CPF" placeholder="Ex: 123.456.789-00" outlined dense style="width: 90%;"
          v-model="responsavel.cpf"></v-text-field>
        <v-text-field class="mb-2" label="Email" placeholder="Ex: mariafernanda2020@gmail.com" outlined dense
          style="width: 90%;" v-model="responsavel.email"></v-text-field>
        <v-text-field class="mb-2" label="Telefone" placeholder="Ex: (99) 9 9999-9999" outlined dense
          style="width: 90%;" v-model="responsavel.telefone"></v-text-field>
        <v-text-field class="mb-2" label="Endereço" placeholder="Ex: Rua Almeida Alves, 5066" outlined dense
          style="width: 90%;" v-model="responsavel.endereco"></v-text-field>
      </v-row>
...
export default {
  data() {
    return {
      ...
      firebase: new FirebaseCRUD("responsaveis"), // Nome no Firestore
      loading: false,
      snackbar: false,
    };
  },
  methods: {
    ...
    async saveAction() {
      ...
      try {
        ...
        await this.firebase.save(responsavelData);
